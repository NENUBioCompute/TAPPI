...
# -----------------------------
url = "https://figshare.com/ndownloader/files/63424329"
local_file = "EE_compare.xlsx"
...
# Assume structure is class_i_type_j
# Group sheets by class index
dataframes = []
num_types = 4
...
labels_show = labels_unique

legend_ax.legend(
    handles_show, labels_show,
    title="Phenotype",
    ncol=len(labels_show),
    loc='center',
    frameon=False,
    fontsize=16,
    title_fontsize=18
...
plt.savefig('EE_compare_raincloud.png', dpi=500, bbox_inches='tight')
plt.rcParams['svg.fonttype'] = 'none'
plt.savefig("EE_compare_raincloud.svg", format="svg", bbox_inches="tight")
plt.show()
