...
# -----------------------------
url = "https://figshare.com/ndownloader/files/63410259"
local_file = "Source_Data_LGS.xlsx"
...
plt.savefig('LGS_raincloud.png', dpi=500, bbox_inches='tight')

plt.rcParams['svg.fonttype'] = 'none'
plt.savefig("LGS_raincloud.svg", format="svg", bbox_inches="tight")
